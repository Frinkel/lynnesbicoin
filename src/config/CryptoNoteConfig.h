...
// Copyright (c) 2018 Frinkeldoodle
//
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2f156c;
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 4; // 4 blocks * 300 sec = 20 mins
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(6969696969696969);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(6942069);
...
*/
const char GENESIS_COINBASE_TX_HEX[] = "010401ff0001f5daa703026d36346a1d0bf90001fdba94429a4242cf5e1427c12c898481f72514d4f31e39210191af5fcec4653382fe2653f4dff1357a99377b9b2ab4ff8ccf7451a6a12c71aa";

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1539662144;
...
const char     CRYPTONOTE_NAME[]                             = "Lynnesbicoin";
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/Frinkel/lynnesbicoin";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x0c, 0x7a, 0xde, 0xf1, 0x5f, 0x17, 0xbf, 0xdb, 0xad, 0xf2, 0xae, 0x94, 0x62, 0xff, 0x0f, 0x6f  }
};
